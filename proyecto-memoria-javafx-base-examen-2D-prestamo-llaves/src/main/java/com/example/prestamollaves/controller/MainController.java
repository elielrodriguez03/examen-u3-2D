...
public class MainController {
    ...
    public void actualizar() {
        if (nombreOriginal == null){
            mostrarMensaje("aviso", "Primero seleccione un registro para actualizar", Alert.AlertType.WARNING);
            return;
        }
        ...
        String error = service.actualizar(nombreOriginal,nuevoNombre, nuevoSalon, nuevoTurno);
    ...
    public void eliminar() {
        ...
        mostrarMensaje("Exito", "Registro eliminado correctamente", Alert.AlertType.INFORMATION);
    }
