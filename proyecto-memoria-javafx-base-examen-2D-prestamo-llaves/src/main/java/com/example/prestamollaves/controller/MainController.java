...
public class MainController {
    ...
    @FXML
    public void agregar() {
        String error = service.agregar(txtNombreSolicitante.getText(), txtSalon.getText(), cbTurno.getValue());
        if (error != null)
        {
            mostrarMensaje("Error", error, Alert.AlertType.INFORMATION);
        } else {
            actualizarLista();
    ...
    public void actualizar() {
        String error = service.actualizar(nombreOriginal, txtNombreSolicitante.getText(), txtSalon.getText(), cbTurno.getValue());
        if (error != null) {
            mostrarMensaje("Error", error, Alert.AlertType.INFORMATION);
        } else {
            actualizarLista();
