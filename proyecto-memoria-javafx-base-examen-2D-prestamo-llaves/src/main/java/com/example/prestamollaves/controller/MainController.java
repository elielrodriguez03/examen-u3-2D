...
public class MainController {
    ...
    public void actualizar() {
        ...
        String nombreSalon = txtSalon.getText();
        String nuevoTurno = cbTurno.getValue();

        String error = service.actualizar(nombreOriginal, nuevoNombre, nombreSalon, nuevoTurno);
    ...
    public void eliminar() {
        ...
        String error = service.eliminar(nombreAEliminar);
        if (error != null) {
            mostrarMensaje("Error", error, Alert.AlertType.ERROR);
            return;
        }
